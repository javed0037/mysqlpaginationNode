...
module.exports = {
    ...
    'muteNotificaton': (req, res) => {
        ...
        if (result.error) {
            ...
            console.log("date for ten degit ....", date)
            ...
            connection.query(query, function (error, results1, fields) {
                if (error) {
                    ...
                    var query1 = 'SELECT * from mutenotifications where toid ="' + toid + '"';// OR fromid =' + req.user.id;
                    connection.query(query1, function (error, results1, fields) {
                        if (error) {
                            ...
                            let query3 = 'UPDATE mutenotifications  SET  ismuteoff = ' + 0 + ',shownotification = ' + shownotification + ',mutenoti = "' + result.value.mutenotitext + '",value = ' + result.value.value + ',settime = ' + date + ',fulloff = ' + 0 + ',updated = ' + date + ' where toid = ' + toid + '';
                            ...
                            var quer = 'insert into mutenotifications(toid,fromid,ismuteoff,shownotification,mutenoti,value,settime,fulloff,updated)values("' + toid + '","' + req.user.id + '","' + 0 + '","' + result.value.shownotification + '","' + result.value.mutenotitext + '","' + result.value.value + '","' + date + '","' + 0 + '","' + date + '")';
